  ...
  render() {
    return (
      <div className="main-content">
        <Container fluid>
          <h4 className="title">
            XS Container <small>Always Horizontal</small>
          </h4>
          <Row>
            <Col xs={4}>
          ...
          <h4 className="title">
            SM Container <small>Collapsed at 768px</small>
          </h4>
          <Row>
            <Col sm={4}>
              <div className="content text-center">
          ...
          <h4 className="title">
            MD Container <small>Collapsed at 992px</small>
          </h4>
          <Row>
            <Col md={4}>
              <div className="content text-center">
          ...
          <h4 className="title">
            LG Container <small>Collapsed at 1200px</small>
          </h4>
          <Row>
            <Col lg={4}>
              <div className="content text-center">
          ...
          <h4 className="title">
            Offset Container <small>Adding some space when needed</small>
          </h4>
          <Row>
            <Col md={4}>
              <div className="content text-center">
