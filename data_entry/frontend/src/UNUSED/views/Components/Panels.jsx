...
class Panels extends Component {
  ...
  render() {
    const defaultPanel = (
      <CardGroup id="panels" ref="panels" onClick={() => this.forceUpdate()}>
        <Card eventKey="1">
          <Card.Heading>
            <Card.Title toggle>
    ...
    const accordionPanel = (
      ...
      >
        <Card eventKey="1">
          <Card.Heading>
            <Card.Title toggle>Accordion Item #1</Card.Title>
          </Card.Heading>
          <Card.Body collapsible>
            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
            terry richardson ad squid. 3 wolf moon officia aute, non cupidatat
        ...
        <Card eventKey="2">
          <Card.Heading>
            <Card.Title toggle>Accordion Item #2</Card.Title>
          </Card.Heading>
          <Card.Body collapsible>
            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
            terry richardson ad squid. 3 wolf moon officia aute, non cupidatat
        ...
        <Card eventKey="3">
          <Card.Heading>
            <Card.Title toggle>Accordion Item #3</Card.Title>
          </Card.Heading>
          <Card.Body collapsible>
            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
            terry richardson ad squid. 3 wolf moon officia aute, non cupidatat
